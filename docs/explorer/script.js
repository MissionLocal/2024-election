        ...
        if (localColumnSums[0] > 0) {
            ...
            for (let i = 0; i < columns.length; i++) {
                ...
                if (localRateElement && markTextElement && cityRateElement && labelElement && percentageElement) {
                    ...
                    markTextElement.innerHTML = "<span class='bar-highlight local-highlight'>" + String(localRates[i].toFixed(2)) + "%</span>";
                    ...
                    percentageElement.innerHTML = "<span class='bar-highlight overall-highlight'>" + String(cityRates[i].toFixed(2)) + "%</span>";
